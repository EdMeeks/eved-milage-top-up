...
router.all('/a-starting-screens/check-vehicle-details', function (req, res, next) {
  const vrm = req.session.data['../v1/vehicleRegistration']
...
router.post('/a-starting-screens/which-document-do-you-have-answer', function (req, res) {
  ...
  if (documentType === 'v5c') {
    return res.redirect('../v1/a-starting-screens/V5C')
  }

  if (documentType === 'last-chance') {
    return res.redirect('../v1/a-starting-screens/last-chance-letter')
  }
  ...
  if (documentType === 'email') {
    return res.redirect('../v1/a-starting-screens/email')
  }

  // If nothing selected, send them back 
  return res.redirect('../v1/a-starting-screens/which-document-do-you-have')
})
...
router.post('/b-eVED-screens/how-long-answer', function (req, res) {
  ...
  return res.redirect('../v1/b-eVED-screens/do-you-know-exact-mileage')
})
...
router.post('/v1/b-eVED-screens/mileage-answer-1', function (req, res) {
  const mileageUnit = req.session.data['mileageUnit']
  const milesInput = req.session.data['exactMileageMiles']
  const kmInput = req.session.data['exactMileageKm']
...
if (mileageUnit === 'miles' && cleanedMiles !== '') {
  ...
  return res.redirect('../b-eVED-screens/mileage-balance-1')
}
...
router.get('b-eVED-screens/mileage-balance-1', function (req, res) {
  ...
  res.render('b-eVED-screens/mileage-balance-1', {
    isLess,
...
router.post('/b-eVED-screens/estimate-your-miles-answer', function (req, res) {
  ...
  return res.redirect('../v1/b-eVED-screens/your-payment-summary-Y2')
})
...
const ddTwiceYearly = total / 2
  ...
  return res.render('../v1c-payment-screens/choose-how-to-pay', { data })
})
...
router.post('/c-payment-screens/choose-how-to-pay', function (req, res) {
  ...
  if (method === 'card') {
    return res.redirect('../v1/c-payment-screens/direct-debit-filler')
  }

  // Any Direct Debit option -> filler for now
  if (method === 'dd-monthly' || method === 'dd-6' || method === 'dd-12') {
    return res.redirect('../v1/c-payment-screens/dd-payment-screens/pay-by-dd-redesign')
  }

  // Nothing selected -> show error
  data.paymentMethodError = true
  return res.redirect('../v1/c-payment-screens/choose-how-to-pay')
})

// GET – show card payment details
router.get('/c-payment-screens/card-payment-details', function (req, res) {
  return res.render('../v1c-payment-screens/card-payment-details')
})
...
router.post('/c-payment-screens/contact-details', function (req, res) {
  ...
  if (
    ...
    return res.redirect('../v1/d-confirmation-screens/DD-confirmation-page')
  }
